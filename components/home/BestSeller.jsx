...
const products = [
  {
    ...
    price: 16.95,
    images: ["/assets/products/orange-1.jpg", "/assets/products/white-8.jpg"],
    colors: [
      {
        name: "Orange",
        value: "bg-orange-3",
        image: "/assets/products/orange-1.jpg",
      },
      {
        name: "Black",
        value: "bg-black",
        image: "/assets/products/black-20.jpg",
      },
      {
        name: "White",
        value: "bg-white",
        image: "/assets/products/white-2.jpg",
      },
    ],
    sizes: ["S", "M", "L", "XL"],
  },
  {
    ...
    price: 18.95,
    images: ["/assets/products/brown.jpg", "/assets/products/purple.jpg"],
    colors: [
      { name: "Brown", value: "bg-brown", image: "/assets/products/brown.jpg" },
      {
        name: "Light Purple",
        value: "bg-purple",
        image: "/assets/products/purple.jpg",
      },
      {
        name: "Light Green",
        value: "bg-light-green",
        image: "/assets/products/green.jpg",
      },
    ],
    sizes: ["M", "L", "XL"],
    countdown: true,
  },
  {
    ...
    price: 10.0,
    images: ["/assets/products/white-6.jpg", "/assets/products/white-8.jpg"],
  },
  {
    id: 4,
    name: "Oversized Printed T-shirt",
    price: 16.95,
    images: ["/assets/products/white-14.jpg", "/assets/products/pink-1.jpg"],
    colors: [
      {
        name: "White",
        value: "bg-white",
      ...
      },
      {
        name: "Pink",
        value: "bg-purple",
        image: "/assets/products/pink-1.jpg",
      },
      {
        name: "Black",
        value: "bg-black",
        image: "/assets/products/black-3.jpg",
      },
    ],
    sizes: ["S", "M", "L", "XL"],
  },
  {
    ...
    price: 114.95,
    images: ["/assets/products/brown.jpg", "/assets/products/brown-3.jpg"],
    colors: [
      {
        name: "Brown",
        value: "bg-brown",
        image: "/assets/products/brown-2.jpg",
      },
      {
        name: "White",
        value: "bg-white",
        image: "/assets/products/white-6.jpg",
      },
    ],
    sizes: ["S", "M", "L", "XL"],
  },
  {
    ...
    price: 10.0,
    images: [
      "/assets/products/light-green-1.jpg",
      "/assets/products/light-green-2.jpg",
    ],
    colors: [
      {
        name: "Light Green",
        value: "bg-light-green",
        image: "/assets/products/light-green-1.jpg",
      },
      {
        name: "Black",
        value: "bg-black",
        image: "/assets/products/black-4.jpg",
      },
      {
        name: "Blue",
        value: "bg-blue-500",
      ...
      },
      {
        name: "Dark Blue",
        value: "bg-dark-blue",
        image: "/assets/products/dark-blue.jpg",
      },
      {
        name: "White",
        value: "bg-white",
      ...
      },
      {
        name: "Light Grey",
        value: "bg-light-grey",
        image: "/assets/products/light-grey.jpg",
      },
    ],
  },
  {
    ...
    price: 10.0,
    images: ["/assets/products/black-5.jpg", "/assets/products/black-6.jpg"],
    colors: [
      {
        name: "Black",
        value: "bg-black",
        image: "/assets/products/black-7.jpg",
      },
      {
        name: "Dark Blue",
        value: "bg-dark-blue",
        image: "/assets/products/dark-blue-2.jpg",
      },
      { name: "Beige", value: "bg-beige", image: "/assets/products/beige.jpg" },
      {
        name: "Light Blue",
        value: "bg-light-blue",
        image: "/assets/products/light-blue.jpg",
      },
      {
        name: "White",
        value: "bg-white",
        image: "/assets/products/white-8.jpg",
      },
    ],
    sizes: ["S", "M", "L"],
  },
  {
    ...
    price: 9.95,
    images: ["/assets/products/white-14.jpg", "/assets/products/black-9.jpg"],
    colors: [
      {
        name: "White",
        value: "bg-white",
      ...
      },
      {
        name: "Black",
        value: "bg-black",
        image: "/assets/products/black-19.jpg",
      },
      {
        name: "Blue",
        value: "bg-blue-500",
        image: "/assets/products/blue-2.jpg",
      },
    ],
    sizes: ["S", "M", "L", "XL"],
  },
