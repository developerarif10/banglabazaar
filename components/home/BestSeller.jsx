...
const products = [
  {
    ...
    price: 16.95,
    images: ["/images/products/orange-1.jpg", "/images/products/white-8.jpg"],
    colors: [
      {
        name: "Orange",
        value: "bg-orange-3",
  ...
  },
  {
    ...
    price: 10.0,
    images: ["/images/products/white-6.jpg", "/images/products/white-8.jpg"],
  },
  {
    id: 4,
    name: "Oversized Printed T-shirt",
    price: 16.95,
    images: ["/images/products/white-14.jpg", "/images/products/pink-1.jpg"],
    colors: [
      {
        name: "White",
        value: "bg-white",
  ...
  },
  {
    ...
    price: 114.95,
    images: ["/images/products/brown.jpg", "/images/products/brown-3.jpg"],
    colors: [
      {
        name: "Brown",
        value: "bg-brown",
  ...
  },
  {
    ...
    price: 10.0,
    images: ["/images/products/black-5.jpg", "/images/products/black-6.jpg"],
    colors: [
      {
        name: "Black",
        value: "bg-black",
  ...
  },
  {
    ...
    price: 9.95,
    images: ["/images/products/white-14.jpg", "/images/products/black-9.jpg"],
    colors: [
      {
        name: "White",
        value: "bg-white",
      ...
      },
      {
        name: "Black",
        value: "bg-black",
        image: "/images/products/black-19.jpg",
      },
      {
        name: "Blue",
        value: "bg-blue-500",
